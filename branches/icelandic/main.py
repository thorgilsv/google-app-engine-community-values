...
from handlers import MainPage, Registration, Login, Assignment, Groups, About, Why, YourOpinion, ForAll, Society, Values, ProjectOwners, Information, Images, Participation
